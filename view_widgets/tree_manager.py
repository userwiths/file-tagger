...
class TreeManager(ttk.Treeview):
    def __init__(self,application,parentContainer,tagManager,indexManager,root,header,populate_tree):
        super().__init__(parentContainer)

        #self.column('#1', minwidth=300, stretch=0)
        #self.heading(1, text="Column 1")
